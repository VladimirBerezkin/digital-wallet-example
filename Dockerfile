...
# Copy container-only permission fix script
COPY docker/fix-permissions-container.sh /usr/local/bin/fix-permissions-container.sh
RUN chmod +x /usr/local/bin/fix-permissions-container.sh
